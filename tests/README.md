...
- **generate_large_test_file.py**: Generates `mock_large_tweets.js` for testing large file uploads
...
```bash
python tests/test_multiworker.py  # Automatically generates large file if needed
```
